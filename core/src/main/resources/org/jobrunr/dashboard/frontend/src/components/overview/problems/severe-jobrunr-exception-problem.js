        ...
        <Alert className={classes.alert} severity="error" action={
            ...
            {props.problem.githubIssueBodyLength < 2000
                ? <>JobRunr encountered an exception that should not happen. To resolve this issue, can you please
                    create a <a
                        href={`https://github.com/LUMASERV/jobrunr/issues/new?title=${encodeURIComponent(props.problem.githubIssueTitle)}&body=${encodeURIComponent(props.problem.githubIssueBody)}&labels=bug`}
                ...
                : <>JobRunr encountered an exception that should not happen. To resolve this issue, can you please
                    create a <a
                        href={`https://github.com/LUMASERV/jobrunr/issues/new?title=${encodeURIComponent(props.problem.githubIssueTitle)}&body=%3C%21--%20Please%20paste%20the%20issue%20content%20generated%20JobRunr%20below.%20--%3E&labels=bug`}
                        target="_blank" rel="noopener noreferrer">Github issue</a>?
