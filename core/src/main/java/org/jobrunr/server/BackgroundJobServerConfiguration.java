...
public class BackgroundJobServerConfiguration {
    ...
    public BackgroundJobServerConfiguration andPollIntervalInSeconds(int pollIntervalInSeconds) {
        if (pollIntervalInSeconds < 1)
            throw new IllegalArgumentException("The pollIntervalInSeconds can not be smaller than 1 (provided: " + pollIntervalInSeconds + ") - otherwise it will cause to much load on your SQL/noSQL datastore.");
